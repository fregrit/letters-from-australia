      ...
      <div class="text-center">
        ...
        <div class="my-5">
          ...
          <p><?= translate("
            ...
            These letters offer a unique glimpse into a family's journey as they settled into a new life on the other side of the world.
          "); ?></p>
        </div>
        ...
        <div class="my-5">
          ...
          "); ?></p>
          <p>
            <a href="https://github.com/fregrit/letters-from-australia" target="_blank" class="btn btn-outline-primary">
              <?= translate("View the project on GitHub"); ?>
            </a>
          </p>
        </div>
        ...
        <div class="mt-5">
          <p><?= translate("
            ...
            We hope these letters bring you as much joy and insight as they have brought to our family.
          "); ?></p>
        </div>
